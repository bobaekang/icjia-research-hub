  ...
  <div>
    ...
    <v-container>
      <v-layout row wrap justify-center>
        <v-flex xs12 sm10 xl8 class="about-item">
          ...
          <p>
            ...
            voluptas laboriosam ab recusandae excepturi eaque dolor id ex
            reiciendis possimus itaque labore natus quibusdam mollitia
            perspiciatis facere, dolores quam! Explicabo, magni. Doloremque,
            corporis ab saepe culpa aliquid dolorem debitis nam!
          </p>
          ...
          <p>
            ...
            <a href="https://vuejs.org/">Vue.js<v-icon>open_in_new</v-icon></a>
            and
          ...
          <p>
            ...
            nemo odio repellendus, quam minus dicta expedita corporis molestiae
            sequi asperiores!
          </p>
        </v-flex>
        ...
        <v-flex xs12 sm10 xl8 class="about-item">
          ...
          <p>
            ...
            lets you find data across state, facts about your state, create maps
            and graphs, and freely download the data for your own analysis. Many
            of these datasets are updated daily, and some even more often.
          </p>
          <p>
            On March 10, 2014, the Illinois General Assembly unanimously passed
            PA 98-0627, a bill introduced by the Governor's Office and intended
            to increase transparency, accountability and savings in government
            by establishing a new State Open Operating Standard.
          </p>
          <p>
        ...
        <v-flex xs12 sm10 xl8 class="about-item">
          ...
          <p>
            ...
            effective. ICJIA’s specific powers and duties are detailed in the
            Illinois Criminal Justice Information Act [
            <a
              href="http://www.ilga.gov/legislation/ilcs/ilcs3.asp?ActID=397&ChapterID=5"
            >
              20 ILCS 3930 et. seq.<v-icon>open_in_new</v-icon>
            </a>
            ].
          </p>
          <p>
            The statutory responsibilities of ICJIA fall under the categories of
            grants administration, research and analysis, policy and planning,
            and information systems and technology.
          </p>
          <p>
            For more information about ICJIA, please visit
            <a href="http://www.icjia.state.il.us">
              the official website<v-icon>open_in_new</v-icon>
            </a>
            .
          </p>
        </v-flex>
